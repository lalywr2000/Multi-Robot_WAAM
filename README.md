...
In particular, this project utilizes and extends functionality from Pyrobopath, a Python package designed for demonstrating multi-robot path planning in additive manufacturing. Pyrobopath includes:

A centralized Bead-level scheduling system

Collision detection using bounding boxes and the python-fcl library

Well-structured data models and algorithms for paths, contours, events, and scheduling

For more details, refer to the main Pyrobopath repository.
